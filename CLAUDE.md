...
# The frontend's own tests: 23 of them, bundling the app's TypeScript with
...
| `web/test/` | 23 test files that bundle the app's TypeScript and run it against a DOM shim (32 cases). |
...
- **`web/test/`** holds 23 frontend tests that bundle the app's TypeScript and run it against a DOM
