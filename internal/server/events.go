...
var (
	...
	EvQueuesCaps         = hub.Declare[map[string]any]("queues:caps")
	EvQueuesError        = hub.Declare[map[string]any]("queues:error")
	EvQueuesOk           = hub.Declare[map[string]any]("queues:ok")
